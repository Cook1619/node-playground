...
let FlavorsByCoffeeLoader = class FlavorsByCoffeeLoader extends dataloader_1.default {
    constructor(coffeesRepository) {
        super((keys) => this.batchLoadFn(keys));
        this.coffeesRepository = coffeesRepository;
    }
    async batchLoadFn(coffeeIds) {
...
//# sourceMappingURL=flavors-by-coffee.loader.js.map